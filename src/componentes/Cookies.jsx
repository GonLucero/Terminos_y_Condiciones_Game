		...
		<div>
			...
			<div style={{ width:'10vw'}}>
					...
					<div style={{width:'65%', backgroundColor:'white', height:'90%', marginTop:'3.5vh', marginLeft:'1vw', border: '2px solid', borderRadius:'0.5vw'}}>
                        ...
                        <img src={estadoCookie === 0  ? cookieentera : cookie} alt='Luna' style={{width:'9vw', position:'fixed', marginTop:'2vh', marginLeft:'3vw'}} onClick={()=>(cambiarEstadoCookie(1),cambiarEstadoModal(1),cambiarTipoModal(1))}></img>
                        <img src={estadoCookie2 === 0  ? cookieentera : cookie} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'30vw', marginTop:'7%'}} onClick={()=>(cambiarEstadoCookie2(1),cambiarEstadoModal(1),cambiarTipoModal(2))}></img>
                        <img src={estadoCookie3 === 0  ? cookieentera : cookie} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'13vw', marginTop:'22%'}} onClick={()=>(cambiarEstadoCookie3(1),cambiarEstadoModal(1),cambiarTipoModal(3))}></img>
                        <img src={estadoCookie4 === 0  ? cookieentera : cookie} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'20vw', marginTop:'13%'}} onClick={()=>(cambiarEstadoCookie4(1),cambiarEstadoModal(1),cambiarTipoModal(4))}></img>
                        <img src={estadoCookie5 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'30vw', marginBottom:'15vh'}} onClick={()=>(cambiarEstadoCookie5(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie6 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'28vw',marginTop:'21vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie6(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie7 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'12vw',marginTop:'3vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie7(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie8 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'3vw',marginTop:'33vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie8(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie9 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'5vw',marginTop:'18vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie9(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie10 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'22vw',marginTop:'7vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie10(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie11 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'10vw',marginTop:'25vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie11(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie12 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'15vw',marginTop:'15vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie12(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie13 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'30vw',marginTop:'35vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie13(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie13 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'22vw',marginTop:'35vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie13(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie15 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'40vw',marginTop:'24vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie15(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie16 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'40vw',marginTop:'12vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie16(1),cambiarEstadoModal2(1))}></img>
                        <img src={estadoCookie17 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'37vw',marginTop:'3vh', position:'absolute'}} onClick={()=>(cambiarEstadoCookie17(1),cambiarEstadoModal2(1))}></img>
                           
                                  {
                                    ...
                                    <div onMouseOver={()=> cambiarhoverBoton(1)} onMouseOut={()=>  cambiarhoverBoton(0)} style={{width:'9vw',height:'10vh', marginLeft:'40vw',marginTop:'40vh', position:'fixed'}}>
                                        <img   src={cookieentera} alt='Luna' style={{width:'9vw', marginLeft:'0vw', position:'absolute',visibility: hoverBoton === 0 ?'hidden' : 'visible'}} onClick={()=>(cambiarEstadoModal(1),cambiarTipoModal(5))}></img>
                                    </div>
                                                            : null
