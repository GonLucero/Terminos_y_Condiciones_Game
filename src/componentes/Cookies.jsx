		...
		<div>
			...
			<div style={{ width:'10vw'}}>
					...
					<div style={{width:'65%', backgroundColor:'white', height:'90%', marginTop:'3.5vh', marginLeft:'1vw', border: '2px solid', borderRadius:'0.5vw'}}>
                        ...
                        <img src={estadoCookie13 === 0  ? cookieentera : luna} alt='Luna' style={{width:'9vw',position:'fixed', marginLeft:'22vw',marginTop:'39vh', position:'absolute'}} onClick={()=>(play(),cambiarEstadoCookie13(1),cambiarEstadoModal2(1))}></img>
